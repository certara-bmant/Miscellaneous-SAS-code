/* ========= CONFIG ========= */
%let xlsx_path = c:/users/bmant/merck_kgaa/MIGX101_Microscopy_DTS_Template.xlsx;   /* <-- set your file path */
%let vlm_sheet = VLM;
...
%build_where;
  ...
  %let facet_order = SPEC TSTDTL  SYM GENSR METHOD ANMETH SCAT ANTREG SPCCND ;

/*GF %let facet_order = SPEC TSTDTL  SYM GENSR METHOD ANMETH SCAT ANTREG SPCCND ;*/
